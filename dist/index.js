// src/encode.ts
import { deflateSync as deflateSync2 } from "zlib";
...
function encode(data, options) {
  ...
  if (compress && data.length > 0) {
    const compressed = new Uint8Array(deflateSync2(Buffer.from(data)));
...
function decode(png) {
  ...
  if (header.compressed) {
    return new Uint8Array(inflateSync2(Buffer.from(trimmed)));
  }
  return trimmed;
}
